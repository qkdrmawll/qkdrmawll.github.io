...
GitHub Copilot이 프로젝트에서 어떻게 행동해야 하는지를 정의합니다. 꼭 지켜야 하는 것, 해도 되는 것, 하면 안 되는 것 등을 명확하게 작성해 AI가 작업할 수 있는 범위를 설정합니다.

### PRD.md

어떤 제품을 만들 것인지, 어떤 기능이 필요한지를 정리하는 제품 요구사항 문서입니다.

### TRD.md

프로젝트에서 사용할 기술 스택과 기술적인 요구사항을 정리합니다.
